...
extension TextColorExtension on Text {
  ...
  Text bgDeepPurple() => copyWith(style: const TextStyle(backgroundColor: Colors.deepPurple));
  ...
  Text bgLightBlue() => copyWith(style: const TextStyle(backgroundColor: Colors.lightBlue));
  ...
  Text bgLightGreen() => copyWith(style: const TextStyle(backgroundColor: Colors.lightGreen));
  ...
  Text bgDeepOrange() => copyWith(style: const TextStyle(backgroundColor: Colors.deepOrange));
  ...
  Text bgBlueGrey() => copyWith(style: const TextStyle(backgroundColor: Colors.blueGrey));

  Text bgRedAccent() => copyWith(style: const TextStyle(backgroundColor: Colors.redAccent));

  Text bgPinkAccent() => copyWith(style: const TextStyle(backgroundColor: Colors.pinkAccent));

  Text bgPurpleAccent() => copyWith(style: const TextStyle(backgroundColor: Colors.purpleAccent));

  Text bgDeepPurpleAccent() => copyWith(style: const TextStyle(backgroundColor: Colors.deepPurpleAccent));

  Text bgIndigoAccent() => copyWith(style: const TextStyle(backgroundColor: Colors.indigoAccent));

  Text bgBlueAccent() => copyWith(style: const TextStyle(backgroundColor: Colors.blueAccent));

  Text bgLightBlueAccent() => copyWith(style: const TextStyle(backgroundColor: Colors.lightBlueAccent));

  Text bgCyanAccent() => copyWith(style: const TextStyle(backgroundColor: Colors.cyanAccent));

  Text bgTealAccent() => copyWith(style: const TextStyle(backgroundColor: Colors.tealAccent));

  Text bgGreenAccent() => copyWith(style: const TextStyle(backgroundColor: Colors.greenAccent));

  Text bgLightGreenAccent() => copyWith(style: const TextStyle(backgroundColor: Colors.lightGreenAccent));

  Text bgLimeAccent() => copyWith(style: const TextStyle(backgroundColor: Colors.limeAccent));

  Text bgYellowAccent() => copyWith(style: const TextStyle(backgroundColor: Colors.yellowAccent));

  Text bgAmberAccent() => copyWith(style: const TextStyle(backgroundColor: Colors.amberAccent));

  Text bgOrangeAccent() => copyWith(style: const TextStyle(backgroundColor: Colors.orangeAccent));

  Text bgDeepOrangeAccent() => copyWith(style: const TextStyle(backgroundColor: Colors.deepOrangeAccent));
}

extension FontExtension on Text {
  Text fontSize(double fontSize, [bool responsive = false]) {
    return setFontSize(responsive ? fontSize.spMin : fontSize);
  }
