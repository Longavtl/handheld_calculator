...
class TopSnackBarRoute<T> extends OverlayRoute<T> {
  ...
  late final Completer<T> _transitionCompleter = Completer<T>();
    ...
    switch (status) {
      ...
      case AnimationStatus.dismissed:
        ...
        'We might still be the current '
            ...
            'animation to the dismissed status before popping the navigator');
  ...
  @override
  String toString() {
    return '$runtimeType(animation: $animationController)';
  }
