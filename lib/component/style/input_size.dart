...
class FInputSize {
  ...
  static const FInputSize size35 = FInputSize(
    height: 35,
  ...
  static const FInputSize size50 = FInputSize(
    height: 50,
  ...
  static const FInputSize size124 = FInputSize(
    height: 124,
    borderRadius: Radius.circular(8.0),
    contentPadding: EdgeInsets.symmetric(vertical: 10),
  );
  static const FInputSize size256 = FInputSize(
    height: 96,
    borderRadius: Radius.circular(8.0),
    contentPadding: EdgeInsets.symmetric(vertical: 10),
  );
